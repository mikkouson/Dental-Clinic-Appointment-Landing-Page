    ...
    <div className="w-full md:h-[calc(100vh-64px)] flex flex-col md:flex-row items-center justify-between p-4 px-6">
      <div id="home" className="w-full md:w-1/2">
        ...
        <p className="text-gray-700 mb-6">
          From routine checkups to advanced cosmetic treatments, our dedicated
          team of professionals is here to give you the healthy, radiant smile
          you deserve. Step into our clinic and experience personalized care
      ...
      <div className="relative w-full md:w-1/2 mt-10 md:mt-0 flex justify-center items-center hidden lg:block">
